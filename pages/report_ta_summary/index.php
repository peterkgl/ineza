...
if (!hasPermission($conn, $userId, 'view_report_ta_summary')) {
    header("Location: ../dashboard");
    exit();
}
$report_slug = 'ta_summary';
...
// Query product elements dynamically based on graded elements in the filtered period for Ta (product_id = 2)
  ...
  <div class="content">
    ...
    <div class="page-header">
      <div>
        ...
        <div class="page-sub">INEZA African Mining Ltd — Summary for Ta under processing</div>
      </div>
