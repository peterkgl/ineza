      ...
      <div class="recon-container">
        ...
        <div class="recon-section">
          ...
          <div class="recon-row">
            ...
            <span><strong><?php echo $curr_symbol . number_format($statement_balance, 0); ?></strong></span>
          </div>
          ...
          <?php foreach ($deposits_in_transit as $dit): ?>
            <div class="recon-row" style="padding-left: 20px; color: var(--text-secondary);">
              ...
              <span><?php echo $curr_symbol . number_format($dit['amount'], 0); ?></span>
            </div>
          <?php endforeach; if (empty($deposits_in_transit)): ?>
            <div class="recon-row" style="padding-left: 20px; color: var(--text-secondary); font-style: italic;">
              ...
              <span><?php echo $curr_symbol; ?>0</span>
            </div>
          <?php endif; ?>
          ...
          <?php foreach ($outstanding_checks as $oc): ?>
            <div class="recon-row" style="padding-left: 20px; color: var(--text-secondary);">
              ...
              <span>(<?php echo $curr_symbol . number_format($oc['amount'], 0); ?>)</span>
            </div>
          ...
          <div class="recon-row total">
            ...
            <span><?php echo $curr_symbol . number_format($adjusted_bank, 0); ?></span>
          </div>
        </div>
        ...
        <div class="recon-section">
          ...
          <div class="recon-row">
            ...
            <span><strong><?php echo $curr_symbol . number_format($book_balance, 0); ?></strong></span>
          </div>
          ...
          <?php foreach ($unrecorded_payments as $up): ?>
            <div class="recon-row" style="padding-left: 20px; color: var(--text-secondary);">
              ...
              <span><?php echo $curr_symbol . number_format($up['amount'], 0); ?></span>
            </div>
          ...
          <div class="recon-row total">
            ...
            <span><?php echo $curr_symbol . number_format($adjusted_book, 0); ?></span>
          </div>
        </div>
        ...
        <div class="recon-row difference">
          ...
          <span><?php echo $curr_symbol . number_format($diff, 0); ?></span>
        </div>
      </div>
