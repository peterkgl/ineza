...
$permissions = [
    ['name' => 'View Units of Measure', 'code' => 'view_unit_of_measure'],
    ['name' => 'Create Unit of Measure', 'code' => 'create_unit_of_measure'],
    ['name' => 'Edit Unit of Measure', 'code' => 'edit_unit_of_measure'],
    ['name' => 'Delete Unit of Measure', 'code' => 'delete_unit_of_measure']
];
