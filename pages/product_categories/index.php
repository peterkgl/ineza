  ...
  <div class="content" id="categoriesContent">
    ...
    <div class="categories-grid">
      ...
      <div class="card">
            ...
            <tbody id="categoriesList">
              ...
              if ($result && mysqli_num_rows($result) > 0) {
                  while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo '<tr>';
                      echo '<td>' . $rowNum++ . '</td>';
                      echo '<td class="td-bold">' . htmlspecialchars($row['category_code']) . '</td>';
                      echo '<td class="td-name">' . htmlspecialchars($row['category_name']) . '</td>';
                  ...
                  echo '<tr><td colspan="6" class="table-empty">No product categories found.</td></tr>';
              }
              ?>
            </tbody>
          </table>
        ...
        <script>
          window.initialCategoriesData = <?php echo json_encode($categoriesData); ?>;
        </script>
      </div>
